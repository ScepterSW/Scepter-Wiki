...
typedef enum
{
    ...
    SC_TRANSFORM_COLOR_IMG_TO_DEPTH_SENSOR_FRAME = 4,   //表示映射到深度传感器空间的彩色图像类型
                                                        //可以使用scSetTransformColorImgToDepthSensorEnabled()启用此帧类型
    SC_TRANSFORM_DEPTH_IMG_TO_COLOR_SENSOR_FRAME = 5,   //表示映射到彩色传感器空间的深度图像类型
                                                        //可以使用scSetTransformDepthImgToColorSensorEnabled()启用此帧类型
} ScFrameType;
```

### 3.1.4.1.2. ScPixelFormat
...
typedef enum
{
    ...
    // Color
    SC_PIXEL_FORMAT_RGB_888_JPEG = 3,   //表示通过JPEG解压缩，每个像素数据为 24 位的 RGB 值
    SC_PIXEL_FORMAT_BGR_888_JPEG = 4,   //表示通过JPEG解压缩，每个像素数据为 24 位的 BGR 值
    SC_PIXEL_FORMAT_RGB_888      = 5,   //表示无压缩，每个像素数据为 24 位的 RGB 值
    SC_PIXEL_FORMAT_BGR_888      = 6,   //表示无压缩，每个像素数据为 24 位的 BGR 值
    SC_PIXEL_FORMAT_RGB_565      = 7,   //表示无压缩，每个像素数据为 16 位的 RGB 值
    SC_PIXEL_FORMAT_BGR_565      = 8    //表示无压缩，每个像素数据为 16 位的 BGR 值
} ScPixelFormat;
```

### 3.1.4.1.3. ScSensorType
...
{
    SC_OK                           = 0,      //表示调用成功
    SC_NO_DEVICE_CONNECTED          = -1,     //表示当前无设备连接
...
### 3.1.4.1.7. ScExposureControlMode
...
### 3.1.4.2.6. ScSensorIntrinsicParameters
...
### 3.1.4.2.7. ScSensorExtrinsicParameters
...
### 3.1.4.2.12. ScConfidenceFilterParams
...
### 3.1.4.2.13. ScFlyingPixelFilterParams
...
### 3.1.4.2.14. ScIRGMMCorrectionParams
...
### 3.1.4.2.15. ScExposureTimeParams
...
### 3.1.4.2.16. ScInputSignalParamsForHWTrigger
...
### 3.1.4.2.17. ScOutputSignalParams
...
- SC_OK：调用成功
- [[其他值](#\_2514-scstatus)](#_2514-scstatus)：调用失败

### 3.1.4.3.2. scShutdown
...
### 3.1.4.3.17. scSetSoftwareSlaveTrigger
...
### 3.1.4.3.18. scGetSensorIntrinsicParameters
...
### 3.1.4.3.19. scGetSensorExtrinsicParameters
...
### 3.1.4.3.20. scGetFirmwareVersion
...
### 3.1.4.3.21. scGetDeviceMACAddress
...
### 3.1.4.3.24. scSetIRGMMCorrection
...
### 3.1.4.3.25. scGetIRGMMCorrection
...
### 3.1.4.3.26. scSetColorPixelFormat
...
### 3.1.4.3.29. scSetColorResolution
...
### 3.1.4.3.30. scGetColorResolution
...
### 3.1.4.3.31. scGetSupportedResolutionList
...
### 3.1.4.3.34. scSetExposureControlMode
...
### 3.1.4.3.35. scGetExposureControlMode
...
### 3.1.4.3.38. scGetMaxExposureTime
...
int32_t\* pMaxExposureTime：返回获取的最大曝光时间
...
### 3.1.4.3.39. scSetTimeFilterParams
...
### 3.1.4.3.40. scGetTimeFilterParams
...
### 3.1.4.3.41. scSetConfidenceFilterParams
...
### 3.1.4.3.42. scGetConfidenceFilterParams
...
### 3.1.4.3.43. scSetFlyingPixelFilterParam
...
### 3.1.4.3.44. scGetFlyingPixelFilterParams
...
### 3.1.4.3.45. scSetFillHoleFilterEnabled
...
### 3.1.4.3.46. scGetFillHoleFilterEnabled
...
### 3.1.4.3.47. scSetSpatialFilterEnabled
...
### 3.1.4.3.48. scGetSpatialFilterParams
...
### 3.1.4.3.49. scSetTransformColorImgToDepthSensorEnabled
...
### 3.1.4.3.50. scGetTransformColorImgToDepthSensorEnabled
...
### 3.1.4.3.51. scSetTransformDepthImgToColorSensorEnabled
...
### 3.1.4.3.52. scGetTransformDepthImgToColorSensorEnabled
...
### 3.1.4.3.53. scTransformedDepthPointToColorPoint
...
### 3.1.4.3.54. scConvertDepthToPointCloud
...
### 3.1.4.3.55. scConvertDepthFrameToPointCloudVector
...
### 3.1.4.3.56. scSetHotPlugStatusCallback
...
### 3.1.4.3.60. scSetHDRModeEnabled
...
### 3.1.4.3.61. scGetHDRModeEnabled
...
### 3.1.4.3.62. scSetInputSignalParamsForHWTrigger
...
### 3.1.4.3.63. scGetInputSignalParamsForHWTrigger
...
### 3.1.4.3.64. scSetOutputSignalParams
...
### 3.1.4.3.65. scGetOutputSignalParams
