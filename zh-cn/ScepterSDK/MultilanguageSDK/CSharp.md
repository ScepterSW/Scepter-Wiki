...
C# SDK 开发包提供的 Sample 用于演示 SDK 的 API 接口使用，

目录包含个人计算机平台(x86_64) Windows PC 开发包, 使用标准编译器 VS2017, 目录结构如下：
...
const [ScIRGMMCorrectionParams](#_324214-scirgmmcorrectionparams) params：IR GMM 校正的值
...
const [ScFlyingPixelFilterParams](#_324213-scflyingpixelfilterparams) params：滤波参数
...
const [ScDepthVector3](#_32423-scdepthvector3) depthPoint：深度图像的坐标点

const [ScVector2u16](#_32422-scvector2u16) colorSize：彩色图像尺寸
...
const [ScFrame](#_32428-scframe)\* pDepthFrame：深度图像
