...
### 3.1.5.2.6. ScSensorIntrinsicParameters
...
### 3.1.5.2.7. ScSensorExtrinsicParameters
...
### 3.1.5.2.12. ScConfidenceFilterParams
...
### 3.1.5.2.13. ScFlyingPixelFilterParams
...
### 3.1.5.2.14. ScIRGMMCorrectionParams
...
### 3.1.5.2.15. ScExposureTimeParams
...
### 3.1.5.2.16. ScInputSignalParamsForHWTrigger
...
### 3.1.5.2.17. ScOutputSignalParams
...
[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败
...
[**ScDeviceInfo**](#_315210-scdeviceinfo)\* pDevicesInfo：返回设备信息

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.6. GetDeviceInfoList
...
[**ScDeviceInfo**](#_315210-scdeviceinfo)* pDevicesInfo：返回设备信息列表，其应该指向大小为 sizeof(ScDeviceInfo)*deviceCount 大小的缓存

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.7. scOpenDeviceByUri
...
[**ScFrameReady**](#_31529-scframeready)\* pFrameReady：返回图像的就绪状态

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.14. scGetFrame
...
[**ScFrameType**](#_31511-scframetype) frameType：待获取图像的类型

[**ScFrame**](#_31528-scframe)\* pScFrame：返回的图像数据

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.15. scSetWorkMode
...
[**ScWorkMode**](#_31516-scworkmode) mode：要设置的工作模式

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.16. scGetWorkMode
...
[**ScWorkMode**](#_31516-scworkmode)\* pMode：获取到的设备的工作模式

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.17. scSoftwareTriggerOnce
...
### 3.1.5.3.18. scGetSensorIntrinsicParameters
...
[**ScSensorType**](#_31513-scsensortype) sensorType：传感器类型

[**ScSensorIntrinsicParameters**](#_31526-scsensorintrinsicparameters)\* pSensorIntrinsicParameters：返回传感器镜头的内参

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.19. scGetSensorExtrinsicParameters
...
[**ScSensorExtrinsicParameters**](#_31527-scsensorextrinsicparameters)\* pSensorExtrinsicParameters：返回设备的外参

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.20. scGetFirmwareVersion
...
### 3.1.5.3.21. scGetDeviceMACAddress
...
### 3.1.5.3.24. scSetIRGMMCorrection
...
<span style="color: #4ec9b0; font-weight: bold">const</span> [**ScIRGMMCorrectionParams**](#_315214-scirgmmcorrectionparams) params：IR GMM 校正的值

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.25. scGetIRGMMCorrection
...
### 3.1.5.3.26. scSetColorPixelFormat
...
[**ScPixelFormat**](#_31512-scpixelformat) pixelFormat：要设置的彩色图像的像素格式
...
### 3.1.5.3.29. scSetColorResolution
...
### 3.1.5.3.30. scGetColorResolution
...
[**ScSensorType**](#_31513-scsensortype) type：传感器类型
...
### 3.1.5.3.34. scSetExposureControlMode
...
[**ScSensorType**](#_31513-scsensortype) sensorType：要设置曝光模式的传感器类型

[**ScExposureControlMode**](#_31517-scexposurecontrolmode) controlMode：要设置的曝光模式

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.35. scGetExposureControlMode
...
[**ScSensorType**](#_31513-scsensortype) sensorType：要获取曝光模式的传感器类型
...
[**ScSensorType**](#_31513-scsensortype) sensorType：要获取曝光时间的传感器类型

[**ScExposureTimeParams**](#_315215-scexposuretimeparams) exposureTime：要设置的曝光时间参数

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.37. scGetExposureTime
...
[**ScExposureTimeParams**](#_315215-scexposuretimeparams)\* pExposureTime：返回获取的曝光时间参数
...
### 3.1.5.3.39. scSetTimeFilterParams
...
[**ScTimeFilterParams**](#_315211-sctimefilterparams) params：指向存储返回值的变量的指针

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.40. scGetTimeFilterParams
...
### 3.1.5.3.41. scSetConfidenceFilterParams
...
[**ScConfidenceFilterParams**](#_315212-scconfidencefilterparams) params：指向存储返回值的变量的指针

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.42. scGetConfidenceFilterParams
...
### 3.1.5.3.43. scSetFlyingPixelFilterParam
...
<span style="color: #4ec9b0; font-weight: bold">const</span> [**ScFlyingPixelFilterParams**](#_315213-scflyingpixelfilterparams) params：滤波参数

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.44. scGetFlyingPixelFilterParams
...
[**ScFlyingPixelFilterParams**](#_315213-scflyingpixelfilterparams)\* params：滤波参数

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.45. scSetFillHoleFilterEnabled
...
### 3.1.5.3.46. scGetFillHoleFilterEnabled
...
### 3.1.5.3.47. scSetSpatialFilterEnabled
...
### 3.1.5.3.48. scGetSpatialFilterParams
...
### 3.1.5.3.49. scSetTransformColorImgToDepthSensorEnabled
...
### 3.1.5.3.50. scGetTransformColorImgToDepthSensorEnabled
...
### 3.1.5.3.51. scSetTransformDepthImgToColorSensorEnabled
...
### 3.1.5.3.52. scGetTransformDepthImgToColorSensorEnabled
...
### 3.1.5.3.53. scTransformedDepthPointToColorPoint
...
### 3.1.5.3.55. scConvertDepthFrameToPointCloudVector
...
<span style="color: #4ec9b0; font-weight: bold">const</span> [**ScFrame**](#_31528-scframe)\* pDepthFrame：深度图像
...
### 3.1.5.3.56. scSetHotPlugStatusCallback
...
### 3.1.5.3.60. scSetHDRModeEnabled
...
### 3.1.5.3.61. scGetHDRModeEnabled
...
### 3.1.5.3.62. scSetInputSignalParamsForHWTrigger
...
[**ScInputSignalParamsForHWTrigger**](#_315216-scinputsignalparamsforhwtrigger) params：硬触发的输入信号参数

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.63. scGetInputSignalParamsForHWTrigger
...
### 3.1.5.3.64. scSetOutputSignalParams
...
[**ScOutputSignalParam**s](#_315217-scoutputsignalparams) params：输出信号参数

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.65. scGetOutputSignalParams
...
[**ScOutputSignalParams**](#_315217-scoutputsignalparams)\* params：输出信号参数

**返回值：**

[**ScStatus**](#_31514-scstatus)：SC_OK 调用成功，其他值调用失败

### 3.1.5.3.66. scSetParamsByJson
