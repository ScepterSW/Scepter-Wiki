...
const [ScIRGMMCorrectionParams](#_315214-scirgmmcorrectionparams) params：IR GMM 校正的值
...
const [ScFlyingPixelFilterParams](#_315213-scflyingpixelfilterparams) params：滤波参数
...
const [ScDepthVector3](#_31523-scdepthvector3) depthPoint：深度图像的坐标点

const [ScVector2u16](#_31522-scvector2u16) colorSize：彩色图像尺寸
...
const [ScFrame](#_31528-scframe)\* pDepthFrame：深度图像
