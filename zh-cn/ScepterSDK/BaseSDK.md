...
1. 根据实际产品选择对应的 sample，以 NYX650 产品编译 DeviceConnectByAlias 为例
   ...
   ![Compilation](pic/Linux/ArmLinuxCompilation1.png)
   ![Compilation](pic/Linux/ArmLinuxCompilation2.png)
...
2. 编译完成，输出路径为 PrecompiledSamples，进入目录后运行。
   ...
   ![Execution](pic/Linux/ArmLinuxExecution.png)
...
1. Samples/OpenCV/Thirdparty 目录下已经包含 OpenCV 3.4.1 版本，无需额外下载。

   ![UbuntuOpenCV](pic/Linux/UbuntuOpenCV.png)
...
1. Samples/OpenCV/Thirdparty 目录下已经包含 OpenCV 3.4.1 版本，无需额外下载。
   ...
   ![AArch64OpenCV](pic/Linux/AArch64OpenCV.png)
