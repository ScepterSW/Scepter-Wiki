!(function () {
  ...
  (xn.options = xn.setOptions =
    ...
    (xn.parseInline = function (e, n) {
      ...
      try {
        ...
        return (
          n.walkTokens && xn.walkTokens(i, n.walkTokens), mn.parseInline(i, n)
        );
      } catch (e) {
        if (
          ((e.message +=
            ...
            R = {
              ...
              highlightElement: function (e, n, i) {
                ...
                if (
                  ...
                  return (
                    R.hooks.run("complete", r), void (i && i.call(r.element))
                  );
  ...
  function In(t, e) {
    ...
    (this.config = t),
      ...
      (this.toc = []),
      (this.cacheTOC = {}),
      (this.linkTarget = t.externalLinkTarget || "_self"),
      (this.linkRel =
        "_self" === this.linkTarget ? t.externalLinkRel || "noopener" : ""),
    ...
    (this._marked = r),
      (this.compile = function (i) {
        ...
        return (
          o ? (a.toc = a.cacheTOC[n]) : (a.cacheTOC[n] = [].concat(a.toc)), e
        );
      });
  }
  var Nn = {},
      ...
      return (
        ...
        (t.link =
          ...
          (i.link = function (e, n, i) {
            ...
            return (
              (u = t.target || u),
              (r = "_self" === u ? f.config.externalLinkRel || "noopener" : ""),
              (n = a),
              ...
              (n.prototype._bindEventOnRendered = function (e) {
                ...
                !(function (e) {
                  ...
                  i &&
                    ...
                    y(
                      n,
                      w("div", this.compiler.header(e.innerText, 1)).children[0]
                    );
              }),
