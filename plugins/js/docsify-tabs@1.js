  ...
  function n(t) {
    ...
    if (i) {
      ...
      if (
        ...
        if (e.persist) {
          var y = b
              ? Array.apply(null, b.querySelectorAll(".".concat(a.tabBlock)))
              : [],
            p = y.indexOf(l),
        ...
        if (e.sync) {
          var h = b
              ? Array.apply(
                  null,
                  b.querySelectorAll(
                    ".".concat(a.tabButton, '[data-tab="').concat(d, '"]')
                  )
                )
              : [],
          ...
          h.forEach(function (t) {
            ...
            0 !== g.indexOf(d) &&
              (g.unshift(d), sessionStorage.setItem(c.sync, JSON.stringify(g)));
        }
      }
    }
  }
  function i() {
    ...
    if (t && document.querySelector(o)) {
      ...
      if (c.closest) e = c.closest(".".concat(a.tabContent));
        ...
        for (
          e = c.parentNode;
          e !== document.body && !e.classList.contains("".concat(a.tabContent));
                ...
                (c = (function (c, s) {
                  for (
                    var r = c.match(o.codeMarkup) || [],
                      ...
                      i = e.theme
                        ? "".concat(a.tabBlock, "--").concat(e.theme)
                        : "",
                      ...
                      f = function () {
                        ...
                        if (y || p) {
                          ...
                          for (
                            ...
                            (m =
                              (e.tabComments
                                ? o.tabCommentMarkup.exec(r)
                                : null) ||
                              (e.tabHeadings
                                ? o.tabHeadingMarkup.exec(r)
                                : null));
            ...
            s.doneEach(function () {
              ...
              b &&
                ((o = (t = document.querySelector(".".concat(a.tabsContainer)))
                  ? Array.apply(
                      null,
                      t.querySelectorAll(".".concat(a.tabBlock))
                    )
                  : []),
                ...
                o.forEach(function (t, o) {
                  ...
                  c ||
                    (e.sync &&
                      ...
                      (c = n
                        .map(function (o) {
                          return Array.apply(null, t.children).filter(function (
                            t
                          ) {
                            return r(
                              t,
                    ...
                    (c = c || t.querySelector(".".concat(a.tabButton))) &&
                      c.classList.add(a.tabButtonActive));
                }));
            }),
            s.mounted(function () {
